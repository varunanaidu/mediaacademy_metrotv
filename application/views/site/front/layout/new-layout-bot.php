...
<div class="footer">
        ...
        <div class="wrap">
            <div class="foot">
                <div class="foot_fill ct_us">
                    <h3>Contact Us</h3>
                    <span>MEDIA ACADEMY</span>
                    <p>Jl. Pilar Mas Raya Kav. A-D<br/>
                        Kedoya - Kebon Jeruk<br/>
                        Jakarta 11520 - Indonesia<br/>
                        <i class="fa fa-envelope"></i>mail@media-academy.id</p>
                    </div>
                    <div class="foot_fill">
                        <h3>Follow Us</h3>
                        <!-- <p>Follow Our social Media to get the latest news.</p> -->
                        <ul class="sosc">
                            <li><a href="https://twitter.com/" title="twitter"><img src="<?php echo base_url(); ?>assets/images/main/ic_twitter.png" alt="twitter"/></a></li>
                            <li><a href="https://www.instagram.com//?hl=id" title="instagram"><img src="<?php echo base_url(); ?>assets/images/main/ic_instagram.png" alt="instagram"/></a></li>
                            <li><a href="https://www.linkedin.com/" title="linkedin"><img src="<?php echo base_url(); ?>assets/images/main/ic_linkedin.png" alt="linkedin"/></a></li>
                        </ul>
                    </div>
                    <div class="foot_fill comp">
                        <h3>Company</h3>
                        <div class="media_group">
                            <img src="<?php echo base_url(); ?>assets/images/main/media_group.png" alt="">
                        </div>
                            <img src="<?php echo base_url(); ?>assets/images/main/metro.png" alt="">
                            <img src="<?php echo base_url(); ?>assets/images/main/metronews.png" alt="">
                            <img src="<?php echo base_url(); ?>assets/images/main/medcom.png" alt="">
                            <img src="<?php echo base_url(); ?>assets/images/main/mi.png" alt="">
                            <img src="<?php echo base_url(); ?>assets/images/main/lampung.png" alt="">
                            <img src="<?php echo base_url(); ?>assets/images/main/idm.png" alt="">
                            <img src="<?php echo base_url(); ?>assets/images/main/ma.png" alt="">
                     </div>
                </div>
            </div>
        </div>
    ...
    <!-- Js template Plugins -->
    <<!-- script src="<?php echo base_url(); ?>assets/js/template/jquery-3.3.1.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/template/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/template/mixitup.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/template/jquery.slicknav.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/template/owl.carousel.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/template/main.js"></script> -->
</body>
</html>
